...
export default function Home() {
  ...
  const { openAuthModal, handleOpenAuthModal } = useGlobalState();
      ...
      <div className="home-container">
        ...
        <div className="main-content">
          <Typography className="content-desc">
            Connect with friends in private rooms to watch synced videos, share
            real-time reactions, and chat live. Enjoy a seamless, shared viewing
            experience where you can queue videos, switch seamlessly between
            clips, and chat as you watch—all in sync!
          </Typography>
